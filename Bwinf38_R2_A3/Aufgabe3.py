        ...
        for s in nodes:
            for tar, weight in g[s]:
                ...
                if parents[s] is None:
                    pass
                elif dist_to_target[tar] + parents[s][0].get_distance() + distance > max_dist:
                    pass
                elif tar == start:
                    pass
                elif s == start:
...
#d.draw_path(result)
#d.finish()
print('In ' + str(round((time2 - time1), 10) / count * 1000) + ' Milliseconds')